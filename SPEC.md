# やさしい読み上げ (read-aloud-easy)

## 概要
ディスレクシア対応 Web 読み上げ (速度調整、ふりがな、難読箇所ハイライト)
...
## コア機能
tts-controls,furigana-overlay,difficult-highlight,speed-pitch,bookmark
...
- npm run lint 通過
- npm run build 通過
- release/read-aloud-easy.zip 生成
...
- 名前 (ja): やさしい読み上げ
- 名前 (en): 
- 概要 (132字以内, ja): ディスレクシア対応 Web 読み上げ (速度調整、ふりがな、難読箇所ハイライト)
- カテゴリ: アクセシビリティ
- 言語: 日本語, English
- プライバシーポリシー URL: https://github.com/tabisurushosai/read-aloud-easy/blob/main/legal/PRIVACY.md
